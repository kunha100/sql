...
```
The provided reading reminds me of the idea of biopolitics and necropolitics, which are central theoretical framework for my dissertation project. The databases and data systems (in the article) embed certain willingness of state to biopolitically control their citizens. Science and technologies are often considered free from judgement of values, but in fact in their utilization very much reflect the perspectives of their holders. The article shows that databases and data systems create necropolitical zones, which mean the area not covered by the biopolitical control. Those who are not worthy of being biopolitically controlled, in terms of gender or family status, are left outside of state’s perview and facilitated to die. While databases and data systems that I encounter in my day-to-day life might not be a serious issues as life or death questions like registration systems, but they could always embed some form of marginalization and discrimination in their design, due to the prejudices or intension of their creators. I’ve had some issues with filing tax with CRA because of my marital status—I was studying in Canada and I had my spouse in Korea. I was married, but could not select married, because I had to provide her Canadian Tax number, which did not eixst. I decided to choose “single,” but the student volunteer in the university tax service advised me to select “separated,” which caused a lot of problem filing tax when my partner came to Canada to join me later. Such system of CRA was based on design in which married couple should always be together, based on their model Canadian citizens. 
```
